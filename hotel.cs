...
class Hotel
{
    public static void Main(string[] args)
    {
        ...
        do
        {
            ...
            Console.WriteLine("Welcome to Hotel");
            Console.WriteLine("\n        MENU        ");
            Console.WriteLine("1.pasta     - Rs.30");
            Console.WriteLine("2.dosa      - Rs.50");
            Console.WriteLine("3.bhel      - Rs.40");
            Console.WriteLine("4.pizza     - Rs.299");
            Console.WriteLine("5.Noodles   - Rs.199");
